...
const Dialog = ({ isOpen, onClose, onSave, id }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="dialog-content bg-white p-8 rounded-lg shadow-lg z-50 w-1/2">
        <button
        ...
        <form className="dialog-form">
          ...
          <div className="flex justify-around">
            <button
              type="button"
              onClick={onClose}
              className="w-1/4 bg-red-500 text-white py-2 px-4 rounded-lg hover:bg-red-800 transition duration-300"
            >
              Cancel
            </button>
            <button
              type="button"
              onClick={handleSave}
              className="w-1/4 bg-green-500 text-white py-2 px-4 rounded-lg hover:bg-green-800 transition duration-300"
            >
              Confirm
            </button>
          </div>
